...
env.AddSimPostInit(function()
	...
	if not env.GetModConfigData("nope_gem_ingredients") then
		return
	end
	-- anti-nope
	...
	set_ingredients(
		...
		{ Ingredient("wintersfeastfuel", 1), Ingredient(sw and "coconut" or "acorn", 1), Ingredient(sw and "jungletreeseed" or "pinecone", 1) }
	)
	...
	set_ingredients(
		"wx78module_music",
		{ Ingredient("scandata", 4), sw and Ingredient("seashell", 1) or Ingredient("singingshell_octave3", 1, nil, nil, "singingshell_octave3_3.tex") }
	)
